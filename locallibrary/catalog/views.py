...
# For forms allowing librarians to renew books
...
# The following block is for forms for adding/removing authors
# For some reason the decorator method does not work here
#from django.contrib.auth.decorators import permission_required
from django.contrib.auth.mixins import PermissionRequiredMixin
